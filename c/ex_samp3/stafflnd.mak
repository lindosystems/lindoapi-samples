...
ALL : "$(OUTDIR)\stafflnd.exe" "$(OUTDIR)\stafflnd.bsc"
...
CLEAN :
	...
	-@erase "$(INTDIR)\stafflnd.pch"
	-@erase "$(INTDIR)\stafflnd.res"
	-@erase "$(INTDIR)\stafflnd.sbr"
	-@erase "$(INTDIR)\stafflndDlg.obj"
	-@erase "$(INTDIR)\stafflndDlg.sbr"
	-@erase "$(INTDIR)\StdAfx.obj"
	-@erase "$(INTDIR)\StdAfx.sbr"
	-@erase "$(INTDIR)\vc60.idb"
	-@erase "$(INTDIR)\vc60.pdb"
	-@erase "$(OUTDIR)\stafflnd.bsc"
	-@erase "$(OUTDIR)\stafflnd.exe"
...
CPP=xicl6.exe
CPP_PROJ=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "\lindoapi\include" /I "\lindoapi\license" /D "_LINDO_DLL_" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\stafflnd.pch" /Yu"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 
...
BSC32_SBRS= \
	"$(INTDIR)\stafflnd.sbr" \
	"$(INTDIR)\stafflndDlg.sbr" \
	"$(INTDIR)\StdAfx.sbr"

"$(OUTDIR)\stafflnd.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
...
"$(INTDIR)\stafflnd.obj"	"$(INTDIR)\stafflnd.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\stafflnd.pch"
...
"$(INTDIR)\stafflndDlg.obj"	"$(INTDIR)\stafflndDlg.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\stafflnd.pch"
...
CPP_SWITCHES=/nologo /MDd /W3 /Gm /GX /ZI /Od /I "\lindoapi\include" /I "\lindoapi\license" /D "_LINDO_DLL_" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_AFXDLL" /D "_MBCS" /FR"$(INTDIR)\\" /Fp"$(INTDIR)\stafflnd.pch" /Yc"stdafx.h" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /GZ /c 

"$(INTDIR)\StdAfx.obj"	"$(INTDIR)\StdAfx.sbr"	"$(INTDIR)\stafflnd.pch" : $(SOURCE) "$(INTDIR)"
	$(CPP) @<<
  $(CPP_SWITCHES) $(SOURCE)
<<
