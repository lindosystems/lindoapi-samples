...
/* declare an instance of the LINDO model object */
  ...
  *****************************************************************/
   ...
   ****************************************************************/
   nErrorCode = LSreadMPIFile(pModel,"../../data/testgop.mpi");
   ...
   /* optimize */
   printf("\tSearching for Global Solution\n\n");
       ...
       status == LS_STATUS_FEASIBLE )
   {
     ...
     if (nCont < n)
     {
       ...
       nErrorCode = LSgetInfo(pModel, LS_DINFO_GOP_OBJ, &dObj);
         APIERRORCHECK;
